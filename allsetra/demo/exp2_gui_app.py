...
if "df" in st.session_state or uploaded_file is not None:
    ...
    final_df["average_speed"] = final_df["trip_distance_in_km"] / (final_df["trip_duration"] / 3600)

    st.dataframe(final_df[["trip_distance_in_km", "trip_duration" , "average_speed"]].describe())
